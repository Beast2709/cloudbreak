...
public enum AuthorizationResourceAction {
    ...
    DESCRIBE_CUSTOM_CONFIGS("datahub/describeCustomConfigs", AuthorizationResourceType.CUSTOM_CONFIGS),
    CREATE_CUSTOM_CONFIGS("datahub/createCustomConfigs", AuthorizationResourceType.CUSTOM_CONFIGS),
    DELETE_CUSTOM_CONFIGS("datahub/deleteCustomConfigs", AuthorizationResourceType.CUSTOM_CONFIGS),
